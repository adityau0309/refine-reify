  ...
  items: [
    {
      number: "01",
      title: "Collect",
      description: "Get paid faster, without the chasing",
      features: [
        "Automated payment follow-up on every open invoice",
        "Escalation sequencing as invoices age",
        "Cash application and reconciliation",
        "Live AR aging / DSO dashboard & Insights",
      ],
      outcome: "Cash keeps moving without anyone chasing it manually.",
    },
    {
      number: "02",
      title: "Recover",
      description: "Win back the revenue stuck in disputes and delays",
      features: [
        "Dispute investigation and documentation",
        "Missing PO / approval / W-9 chase-down",
        "Enterprise portal submission (Coupa, Ariba)",
    ...
    },
    {
      number: "03",
      title: "Command",
      description: "Know your cash position before you need to",
      features: [
        "13-week rolling cash flow forecast",
        "Weekly AP briefing — what to pay, hold, or discount (you click pay)",
        "Duplicate invoice / billing error screening on outgoing bills",
